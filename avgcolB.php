...
$result = $conn->query("SELECT date, AVG(colB) as avgColB FROM test_spovum GROUP BY date");
...
var y = d3.scaleLinear()
    .range([height, 0])
    .domain([0, d3.max(data, function(d) { return d.avgColB; })]);
...
svg.selectAll(".bar")
    ...
    .attr("y", function(d) { return y(d.avgColB); })
    .attr("height", function(d) { return height - y(d.avgColB); })
    .style("fill", "orange");
