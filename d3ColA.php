...
$result = $conn->query("SELECT slno, colA FROM test_spovum");
...
var y = d3.scaleLinear()
    .range([height, 0])
    .domain([0, d3.max(data, function(d) { return d.colA; })]);
...
svg.selectAll("rect")
    ...
    .attr("y", function(d) { return y(d.colA); })
    .attr("height", function(d) { return height - y(d.colA); })
